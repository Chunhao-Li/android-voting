...
import com.example.votingapp.RecyclerViewMatcher;
...
//    @Rule
//    public IntentsTestRule<VotingEditActivity> intentVotingEditRule =
//            new IntentsTestRule<>(VotingEditActivity.class);
    ...
    @Test
    public void createMultiChoiceQuestionText() {
        onView(allOf(withParent(withId(R.id.fab_menu)), withClassName(endsWith("ImageView")), isDisplayed()))
                .perform(click());
